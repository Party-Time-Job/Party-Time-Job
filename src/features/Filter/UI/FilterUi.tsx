...
const Filter = ({
  ...
  return (
    <div className='absolute z-10 flex w-[390px] flex-col items-start gap-6 rounded-[10px] border border-gray-500 bg-test-black px-5 py-6 shadow-[0px_2px_8px_0px_rgba(120,116,134,0.25)] max-md:inset-0 max-md:w-full md:right-0 md:top-10'>
      ...
      <div className='flex w-full flex-col items-start gap-10'>
        <div className='flex w-[350px] flex-col items-start gap-6 max-md:w-full'>
          <div className='flex flex-col items-start gap-3 max-md:w-full'>
            ...
            <div className='h-[258px] w-full rounded-md border-[1px] border-gray-500 md:w-[350px]'>
                  ...
                  return (
                    <div key={item.key}>
                      <span
                        ...
                        className='cursor-pointer p-2 hover:bg-pt-gray20 hover:text-black'
                      >
                        {item.value}
                      </span>
                    </div>
